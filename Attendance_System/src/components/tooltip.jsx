  ...
  useEffect(() => {
    const handleInfoButtonClick = () => {
      if (!boxShown) {
        ...
        document.querySelector('.infotooltip').style.display = 'none';
        setBoxShown(true);
      } else {
        document.querySelector('.infobox').style.display = 'none';
        if (window.innerWidth > 768) {
          setTimeout(() => {
            if (document.querySelector('.infobutton:hover')) {
              document.querySelector('.infotooltip').style.display = 'block';
            } else {
              document.querySelector('.infotooltip').style.display = 'none';
            }
          }, 700);
